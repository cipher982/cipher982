...
| ⚖️ [**NYC Crime Data Explorer**](https://drose.io/nyc-crime) | Careful recidivism analysis over public NYC arrest/jail data with Polars + DuckDB, shipped as a live Next.js app. |
...
![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) ![Go](https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white) ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white)

Over the last 30 days: **2,669 commits** across **27 repos**. I work alongside coding agents daily (roughly **1295 agent sessions** this month, mostly Claude Code and Codex), but the output is the part that matters.

*Hero dashboard auto-updates daily · last refreshed 2026-08-21 06:27 UTC*
