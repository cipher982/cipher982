...
| Project | Description |
|---------|-------------|
| 🏛️ [**Longhouse**](https://longhouse.ai) | Centralized platform for managing AI agent sessions, insights, memory, and orchestration |
...
- **Avg 6 turns/session** — deep problem-solving, not quick prompts
...
- **Commits**: 935
- **Languages**: Python (816), Shell (79), TypeScript (3), HTML (1)
- **AI Sessions**: Claude 945 · Codex 491 · Cursor 2 · Gemini 62
- **Total Turns**: 11.6k
