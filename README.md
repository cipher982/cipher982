...
|------|---------|-------------|
| **longhouse** | 215 | 230 |
| **llm-vision-explainer** | 0 | 45 |
| **zmp-provisioning-factory** | 0 | 25 |
| **life-hub** | 15 | 9 |
...
- **Commits**: 888
- **Languages**: Python (728), Shell (88), TypeScript (37), JavaScript (5)
- **AI Sessions**: Claude 747 · Codex 650 · Cursor 0 · Gemini 5
- **Total Turns**: 27.6k
